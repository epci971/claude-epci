...
## Usage
```
/wd:review [target] [--focus security|performance|quality|architecture] [--format report|checklist|metrics] [--export <path>]
```
...
/wd:review src/auth/ --focus security --format report

# Performance analysis with metrics
/wd:review --focus performance --format metrics --export ./performance-review.json

# Comprehensive quality review
/wd:review src/ --focus quality --format checklist

# Full system architecture review
/wd:review --focus architecture --format report --export ./architecture-analysis.md
```
