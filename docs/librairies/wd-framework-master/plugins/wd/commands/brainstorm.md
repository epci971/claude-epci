# /wd:brainstorm - Structured Idea Generation
...
## Usage
```
/wd:brainstorm [topic] [--format json|markdown|mindmap] [--depth shallow|deep|comprehensive] [--export <path>]
```
...
/wd:brainstorm "improving user onboarding" --depth shallow

# Comprehensive analysis with export
/wd:brainstorm "microservices architecture" --depth comprehensive --export ./brainstorm-results.md

# Technical solution exploration
/wd:brainstorm "performance optimization strategies" --format json --depth deep
```
