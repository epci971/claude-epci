...
> **Version** : 4.0.0 | **Date** : Décembre 2024
...
├── commands/         # 10 commandes (epci-brief, epci, epci-quick, etc.)
...
```
Brief brut → /epci-brief → Évaluation
                              │
         ┌────────────────────┼────────────────────┐
         ▼                    ▼                    ▼
...
|-----------|----------|----------|
| **TINY** | 1 fichier, < 50 LOC | `/epci-quick` |
| **SMALL** | 2-3 fichiers, < 200 LOC | `/epci-quick` |
| **STANDARD** | 4-10 fichiers, tests requis | `/epci` (3 phases) |
| **LARGE** | 10+ fichiers, architecture complexe | `/epci --large` |
| **SPIKE** | Incertitude technique | `/epci-spike` |
...
| Commande | Rôle |
|----------|------|
| `/epci-brief` | Point d'entrée unique — exploration, clarification, routing |
| `/epci` | Workflow complet 3 phases (STD/LARGE) |
| `/epci-quick` | Workflow condensé (TINY/SMALL) |
| `/epci-spike` | Exploration time-boxée |
| `/brainstorm` | Feature discovery avec personas |
| `/epci-debug` | Diagnostic bugs structuré |
| `/epci-decompose` | Décomposition PRD en sous-specs |
| `/epci-memory` | Gestion mémoire projet |
| `/epci-learn` | Gestion apprentissage |
| `/epci:create` | Component Factory (skill\|command\|agent) |
...
2. → Routing automatique vers /epci-quick ou /epci
