...
description: >-
  ...
  Use when: /decompose --wiggum needs to generate Ralph-compatible outputs.
  Not for: Direct invocation, use /decompose --wiggum instead.
---
...
```json
{
  ...
  "generatedBy": "EPCI /decompose --wiggum",
  "config": {
    "max_iterations": 50,
...
```bash
#!/bin/bash
# Generated by EPCI /decompose --wiggum
...
This skill is invoked internally by `/decompose --wiggum`:
