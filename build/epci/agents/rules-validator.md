...
- [ ] Uses correct markers: `## 🔴 CRITICAL`, `## 🟡 CONVENTIONS`, `## 🟢 PREFERENCES`
...
|-------|----------|--------|
| 🔴 Critical | Invalid YAML, broken paths, missing sections | Must fix |
| 🟠 Important | Token limits exceeded, overlapping rules | Should fix |
| 🟡 Minor | Style inconsistencies, suboptimal patterns | Nice to have |
...
|------|-------------|-------|-----------|--------|--------|
| `CLAUDE.md` | N/A | N/A | OK | 850 | ✅ |
| `rules/backend-django.md` | OK | OK | OK | 1200 | ✅ |
| `rules/testing-pytest.md` | OK | WARN | OK | 980 | ⚠️ |
...
```markdown
# Title Required         ← H1 required

> Description required   ← Blockquote description

## 🔴 CRITICAL           ← At least one severity section

1. **Rule name**         ← Numbered in CRITICAL

## 🟡 CONVENTIONS        ← Optional sections

### Subsection           ← Can have subsections

## Examples              ← Examples section recommended
